...
const CardStyle = "border-4 border-accent rounded-xl flex flex-col h-fit w-8/12 mx-2 mb-3 shadow-2xl items-center";
const CardMotion = {
	hover: {
		scale: 1.02,
...
const InfoNameContainerStyle = "border-b-4 border-accent w-fit flex flex-row justify-center my-2";
const InfoName = styled.p``;
const InfoNameStyle = "font-primary text-chocolate font-medium text-lg";
...
const InfoDetailContainerStyle = "flex flex-row items-center gap-2 w-full mb-4";

const InfoDetailIconContainer = styled.div``;
const InfoDetailIconContainerStyle = "rounded-full h-8 w-8 flex flex-row justify-center items-center bg-accent mx-1";
...
export default function WindowItemCard(props){
	return (
		<Card 
			className={CardStyle}
			as={motion.div}
		...
		>
			...
			<InfoContainer className={InfoContainerStyle}>
				<InfoDetailContainer className={InfoDetailContainerStyle}>
					...
					<InfoStatus className={InfoStatusStyle}>
						{props.info}
					</InfoStatus>
				</InfoDetailContainer>
